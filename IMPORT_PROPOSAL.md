...
- **Sample dev-sandbox upload with errors:** [changeset 616162](https://api06.dev.openstreetmap.org/changeset/616162) — one batch generated by the import tool against `master.apis.dev.openstreetmap.org`, evidence the upload mechanics work end-to-end.
