...
1. **quinte-west** — 18,900 rows, 86.3% missing (survey). Street source: `street`.
2. **cornwall** — 18,330 rows, 81.1% missing. Street source: `full` — first
   city to exercise the full-derivation branch. French suffixes (`RUE`…) live here.
3. **niagara-falls**
